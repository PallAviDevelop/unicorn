        ...
        <div class="flex flex-row" style={{justifyContent: 'space-around'}}>
            ...
            <div class="py-10 w-[500px]">
              <div class="flex items-start">
                <div class="shrink-0">
                  <div class="inline-block rounded-md bg-sky-200 p-4 text-blue-500">
            ...
            <div class="py-10 w-[500px]">
              <div class="flex items-start">
                ...
                <div class="ml-6 grow">
                  ...
                  <p class="text-sm text-neutral-500">
                  CommA1104 Kamdhenu Aura<br/>
Plot No. 17/18, Sector 4Phase 1 <br/>Taloja- Navi Mumbai,Maharashtra 410208,<br/>
INDIAunication
            ...
            <div class="py-10 w-[500px]">
              <div class="align-start flex">
                ...
                <div class="ml-6 grow">
                  <p class="mb-2 font-bold ">Email Id</p>
                  <p class="text-neutral-500">  sales@unicornseafoods.com
                  </p>
                </div>
              </div>
            </div>
